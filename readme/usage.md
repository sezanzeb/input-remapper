...
In the text input field (right-side, output section), type the key to which you would like to map this input (left-side, input section).
...
into the text input field(right-side, output section). If you hit enter, it will switch to a multiline-editor with
line-numbers.
