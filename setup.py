...
setup(
    ...
    url="https://github.com/Qutaiba-Khader/input-remapper-mqtt",
    license="GPL-3.0",
    ...
    data_files=[
        ...
        *lang_data,
        ("/usr/share/input-remapper-mqtt/", glob.glob("data/*")),
        ("/usr/share/applications/", ["data/input-remapper-mqtt-gtk.desktop"]),
        ("/usr/share/icons/hicolor/scalable/apps/", ["data/input-remapper.svg"]),
        ("/usr/share/polkit-1/actions/", ["data/input-remapper.policy"]),
        ("/usr/lib/systemd/system", ["data/input-remapper-mqtt.service"]),
        ("/usr/share/dbus-1/system.d/", ["data/inputremapper.mqtt.Control.conf"]),
        ("/etc/xdg/autostart/", ["data/input-remapper-mqtt-autoload.desktop"]),
        ("/usr/lib/udev/rules.d", ["data/99-input-remapper.rules"]),
        ("/usr/bin/", ["bin/input-remapper-mqtt-gtk"]),
        ("/usr/bin/", ["bin/input-remapper-mqtt-service"]),
        ("/usr/bin/", ["bin/input-remapper-mqtt-control"]),
        ("/usr/bin/", ["bin/input-remapper-mqtt-reader-service"]),
    ],
    install_requires=[
        "setuptools",
        "evdev",
