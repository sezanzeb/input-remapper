...
class TestDataBus(unittest.TestCase):
    def test_calls_listeners(self):
        ...
        data_bus = DataBus()
        listener = Listener()
        data_bus.subscribe(MessageType.test1, listener)
        data_bus.send(Message(MessageType.test1, "foo"))
        data_bus.send(Message(MessageType.test2, "bar"))
    ...
    def test_unsubscribe(self):
        ...
        listener = Listener()
        data_bus.subscribe(MessageType.test1, listener)
        data_bus.send(Message(MessageType.test1, "a"))
        data_bus.unsubscribe(listener)
        data_bus.send(Message(MessageType.test1, "b"))
    ...
    def test_unsubscribe_unknown_listener(self):
        ...
        listener1 = Listener()
        listener2 = Listener()
        data_bus.subscribe(MessageType.test1, listener1)
    ...
    def test_preserves_order(self):
        ...
        def listener1(_):
            data_bus.send(Message(MessageType.test2, "f"))
            calls.append(1)
        ...
        data_bus.subscribe(MessageType.test1, listener1)
        data_bus.subscribe(MessageType.test1, listener2)
        data_bus.subscribe(MessageType.test1, listener3)
        data_bus.subscribe(MessageType.test2, listener4)
        data_bus.send(Message(MessageType.test1, ""))
