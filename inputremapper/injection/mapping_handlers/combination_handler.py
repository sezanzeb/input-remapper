...
class CombinationHandler(MappingHandler):
    ...
    def notify(
        ...
        is_pressed = event.get_pressed() == 1
    ...
    def _handle_freshly_activated(
        ...
        self._output_previously_active = bool(event.get_pressed())
    ...
    def _should_release_event(self, event: InputEvent) -> bool:
        ...
        assert event.get_pressed() == 0, f"expected {event.get_pressed()} to be 0"
